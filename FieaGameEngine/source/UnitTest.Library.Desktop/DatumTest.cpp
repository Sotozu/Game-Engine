	...
	public:
		...
		TEST_METHOD(DatumOOAssignment)
		{
			...
			//Datum with _data initialized to more than one value
			{
				...
				myDatumTypes[1].PushBack(1.0f);
				myDatumTypes[1].PushBack(2.0f);
				myDatumTypes[1].PushBack(3.0f);
				myDatumTypes[1] = myFloat;
				...
				myDatumTypes[2].PushBack("Hello World");
				myDatumTypes[2].PushBack("Hello World");
				myDatumTypes[2].PushBack("Hello World");
				myDatumTypes[2] = myString;
				...
				myDatumTypes[5].PushBack(myRTTI);
				myDatumTypes[5].PushBack(myRTTI);
				myDatumTypes[5].PushBack(myRTTI);
				myDatumTypes[5] = myRTTI;
		...
		TEST_METHOD(DatumOOEqual)
		{
			...
			{
				Datum myDatum1("Hello!");
				Datum myDatum2("Hello!");
...
//#pragma endregion
		...
		TEST_METHOD(DatumSet)
		{
			//Testing on all valid Datum types.
			{
				...
				{ 2, 2.0f, "Alex", myVec2, myMat2, myRTTI2 };
		...
		TEST_METHOD(DatumPushBack)
		{
			//Default Datum
			{
				...
				Assert::AreEqual(DatumTypes::Vector, myDatum4.Type());
		...
		TEST_METHOD(DatumFront)
		{
			...
			//Also attempting to use Front and getting a different type. exception
			{
				...
				Datum myDatum4;
				myDatum4.SetType(DatumTypes::Vector);
