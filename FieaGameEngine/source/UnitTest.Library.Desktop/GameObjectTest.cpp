...
#pragma region GameObject Tests
		TEST_METHOD(GameObjectConstructor)
		{
			...
			Assert::AreEqual(defaultVector, myGameObject._transform._position);
			Assert::AreEqual(defaultVector, myGameObject._transform._rotation);
			Assert::AreEqual(defaultVector, myGameObject._transform._scale);
		}
		TEST_METHOD(GameObjectConstructor_name_transform)
		{
			...
			Assert::AreEqual(position, myGameObject._transform._position);
			Assert::AreEqual(rotation, myGameObject._transform._rotation);
			Assert::AreEqual(scale, myGameObject._transform._scale);
		}
		...
		TEST_METHOD(Clone)
		{
			...
			myGameObject._transform._position = position;
			myGameObject._transform._rotation = rotation;
			myGameObject._transform._scale = scale;

			GameObject* myClone = myGameObject.Clone();

			Assert::AreEqual("Alex"s, myClone->_name);
			Assert::AreEqual(position, myClone->_transform._position);
			Assert::AreEqual(rotation, myClone->_transform._rotation);
			Assert::AreEqual(scale, myClone->_transform._scale);
		...
		TEST_METHOD(GameObjectJsonParse)
		{
			...
			Assert::AreEqual(DatumTypes::Vector, gameObjectPosition->Type());
			...
			Assert::AreEqual(DatumTypes::Vector, gameObjectRotation->Type());
			...
			Assert::AreEqual(DatumTypes::Vector, gameObjectScale->Type());
			...
			Assert::AreEqual("Alex"s, myGameObject->_name);
			Assert::AreEqual(_gameObjectVector, myGameObject->_transform._position);
			Assert::AreEqual(_gameObjectVector, myGameObject->_transform._rotation);
			Assert::AreEqual(_gameObjectVector, myGameObject->_transform._scale);
			...
			Assert::AreEqual(_avatarFooVector, myAvatarFoo->_transform._position);
			Assert::AreEqual(_avatarFooVector, myAvatarFoo->_transform._rotation);
			Assert::AreEqual(_avatarFooVector, myAvatarFoo->_transform._scale);
		...
		TEST_METHOD(GameObjectUpdateChildren)
		{
			...
			myRootGameObject->Update(myGameTime);
