...
namespace UnitTestLibraryDesktop
{
	...
	const Vector<Signature> DerivedAttributedFoo::Signatures()
	{
		return Vector<Signature>
		{
			...
			{ "_DAFexternalVector", DatumTypes::Vector, 1, offsetof(DerivedAttributedFoo, _DAFexternalVector) },
			...
			{ "_DAFexternalVectorArray", DatumTypes::Vector, ArraySize, offsetof(DerivedAttributedFoo, _DAFexternalVectorArray) },
