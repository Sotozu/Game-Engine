...
//			Assert::AreEqual("Alex"s, myAttributedFoo->_externalString);
		...
		{		 
			...
			Assert::AreEqual(DatumTypes::Vector, foundDatumVectorScalar->Type());
			...
			Assert::AreEqual(DatumTypes::Vector, foundDatumVectorArray->Type());
		...
		TEST_METHOD(ParseComplexScope)
		{
			...
			Assert::AreEqual(DatumTypes::Vector, foundDatumVectorScalar3_2_1->Type());
			...
			Assert::AreEqual(DatumTypes::Vector, foundDatumVectorArray3_2_1->Type());
