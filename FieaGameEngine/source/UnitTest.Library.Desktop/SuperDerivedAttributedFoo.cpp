...
namespace UnitTestLibraryDesktop
{
	...
	const Vector<Signature> SuperDerivedAttributedFoo::Signatures()
	{
		return Vector<Signature>
		{
			...
			{ "_SDAFexternalVector", DatumTypes::Vector, 1, offsetof(SuperDerivedAttributedFoo, _SDAFexternalVector) },
			...
			{ "_SDAFexternalVectorArray", DatumTypes::Vector, ArraySize, offsetof(SuperDerivedAttributedFoo, _SDAFexternalVectorArray) },
