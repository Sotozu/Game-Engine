...
namespace UnitTestLibraryDesktop
{
	...
	const Vector<Signature> AttributedFoo::Signatures()
	{
		return Vector<Signature> 
		{
			...
			{"_externalVector", DatumTypes::Vector, 1, offsetof(AttributedFoo, _externalVector)},
			...
			{ "_externalVectorArray", DatumTypes::Vector, ArraySize, offsetof(AttributedFoo, _externalVectorArray) },
