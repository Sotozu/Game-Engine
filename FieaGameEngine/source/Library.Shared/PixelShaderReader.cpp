...
namespace FieaGameEngine
{
	...
	PixelShaderWithClassLinkageReader::PixelShaderWithClassLinkageReader(Game& renderer, com_ptr<ID3D11ClassLinkage> classLinkage) :
		mGame(&renderer), mClassLinkage(classLinkage)
	{
	}
