...
namespace FieaGameEngine
{
	...
	struct AnimationClipData final
	{
		...
		bool operator==(const AnimationClipData& rhs) const
		{
			return Name == rhs.Name &&
				Duration == rhs.Duration &&
				TicksPerSecond == rhs.TicksPerSecond &&
				BoneAnimations == rhs.BoneAnimations &&
				BoneAnimationsByBone == rhs.BoneAnimationsByBone &&
				KeyframeCount == rhs.KeyframeCount;
    ...
    {
    public:
		AnimationClip(ModelResource& model, InputStreamHelper& streamHelper);
		...
		bool operator==(const AnimationClip& rhs) const;

		bool operator!=(const AnimationClip& rhs) const;

    private:
		void Load(ModelResource& model, InputStreamHelper& streamHelper);
