...
namespace FieaGameEngine
{
	...
	public:
		...
		private:
			...
			//pair_type* pair = nullptr; //pointer to the value found 
		};

		//TO DO . ADDED 04/06/2022
		...
		/// <summary>
		/// Inserts a pair into the map. Returns a pair that contains an iterator and bool.
		...
		/// If the key is not found in map then an excpetion is thrown.
		/// </summary>
		/// <param name="key">TKey type wich is what is used to search for a item in the map</param>
