...
#pragma endregion
	...
	AnimationClip::AnimationClip(ModelResource& model, InputStreamHelper& streamHelper)
	{
	...
	void AnimationClip::Load(ModelResource& model, InputStreamHelper& streamHelper)
	{
		streamHelper >> mData.Name >> mData.Duration >> mData.TicksPerSecond;
	...
	bool AnimationClip::operator==(const AnimationClip& rhs) const
	{
