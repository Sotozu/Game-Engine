...
namespace FieaGameEngine
{
	...
	{
		//Good to default it to 0. The struct WNDCLASSEX is huge.
	...
	path UtilityWin32::ExecutableDirectory()
	{
		...
		//GetCommandLine() - The return value is a pointer to the command-line string for the current process.
		//CommandLineToArgvW() - Parses a Unicode command line string and returns an array of pointers to the command line arguments
